...
• Usar con cuidado: Intel avisa que MMU dentro del micro, voltaje
5% superior al nominal puede dañar el microprocesador
...
<TODO>Se debería actualizar la imagen por una tabla y añadir las DDR4</TODO>
...
* **Módulo de memoria**: tarjeta de circuito impreso rectangular donde se
  sueldan chips de memoria (esto se llama el encapsulado)
...
* Son más rápidos que los anteriores, ya que encapsulan chips de memoria de
  tipo RDRAM (Rambus DRAM)
